...
OBS 2: Altere as informações de usuário e senha do MySQL para as suas
...
GET  -> Permite a busca de todos os clientes cadastrados.
...
GET -> Permite a busca de um cliente em específico passando o id.
                                       
PUT -> Altera as informações de um cliente.

---

### http://localhost:8080/clientes/{id}/comprados: 
 
GET -> Retorna a lista de jogos comprados por um cliente.

---

### http://localhost:8080/clientes/{id}/comprar: 
 
PUT -> Permite comprar um jogo ao passar o id do cliente na uri
...
DELETE -> Deleta o cliente com o id passado.
...
GET  -> Retorna os jogos cadastrados.
...
GET -> Retorna um jogo com o id passado.
